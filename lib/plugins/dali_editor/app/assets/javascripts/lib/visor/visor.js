var DaliVisor = (function () {
    ...
    return {
        exports: function (state) {
            ...
            JSZipUtils.getBinaryContent('/assets/lib/visor/dist.zip', function (err, data) {
                if (err) {
                ...
                state.navItemsIds.map(function (page) {
                    var inner = new EJS({url: '/assets/lib/visor/index.js'}).render({
        ...
        exportPage: function (state) {
            ...
            return new EJS({url: '/assets/lib/visor/page.js'}).render({
